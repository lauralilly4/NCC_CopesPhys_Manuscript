...
# FIG. 7a:  Winter PSI avg. vs. BST yearday
plt07a <- ggplot(psi_df, aes(x = Win_PSI, y = BST_yrdy)) + 
...
# # Plot w/ legend
# ggsave("../../../OSU_NOAA_postdoc/Project1_SeasonalUpwelling/Figures/Plots_v4/P7a_WinPSI_v_BST.png", plot = plt07a, width = 1600, height = 1600, units = 'px')




# FIG. 7b:  Winter PSI avg. vs. Summer PSI avg
plt07b <- ggplot(psi_df, aes(x = Win_PSI, y = BST_yrdy)) + 
  geom_point(aes(x = Win_PSI, y = BST_yrdy, color = factor(Nino_lbl))) + 
  geom_smooth(method = 'lm', se = FALSE, color = "black", lwd = 0.3) + 
...
# # Plot w/ legend
# ggsave("../../../OSU_NOAA_postdoc/Project1_SeasonalUpwelling/FIgures/Plots_v4/P7b_WinPSI_v_SumPSI.png", plot = plt07b, width = 1600, height = 1600, units = 'px')
