...
wndfl <- read.csv('Phys_files_2024/NH10_ALF_TrnsDts_Cumu.csv')
# alffl2 <- read.csv('Phys_Inds/NH10_ALF_FlowMagHourly.csv')
alffl2024 <- read.csv('Phys_files_2024/NH10_AlongAcrossFlows_daily.csv')
romsfl1 <- read.csv('Phys_files_2024/ROMS_MGJ_wcra_vars_44.65N_124.2W_1980-2010_monthly.csv')
romsfl2 <- read.csv('Phys_files_2024/ROMS_MGJ_wcra_vars_44.65N_124.2W_2011-2021_monthly.csv')
...
# ALF, v3 -> NEW Along and Across values, Jul 2024
alng_dy <- alffl2024$Along_flow_inst
acrs_dy <- alffl2024$Across_flow_inst
